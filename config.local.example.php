<?php
/**
 * Sash Technologies server configuration.
 *
...
if (!defined('SMTP_USERNAME')) define('SMTP_USERNAME', env_value('SMTP_USERNAME', 'info@sashtechnologies.com'));
if (!defined('SMTP_PASSWORD')) define('SMTP_PASSWORD', env_value('SMTP_PASSWORD', 'xyya rhvb ctkm uwip'));

// Email identities
if (!defined('MAIL_FROM_ADDRESS')) define('MAIL_FROM_ADDRESS', env_value('MAIL_FROM_ADDRESS', 'info@sashtechnologies.com'));
if (!defined('MAIL_FROM_NAME')) define('MAIL_FROM_NAME', env_value('MAIL_FROM_NAME', 'Sash Technologies Website'));
if (!defined('MAIL_TO_ADDRESS')) define('MAIL_TO_ADDRESS', env_value('MAIL_TO_ADDRESS', 'info@sashtechnologies.com'));
if (!defined('MAIL_TO_NAME')) define('MAIL_TO_NAME', env_value('MAIL_TO_NAME', 'Sash Technologies Team'));
...
// Site basics
if (!defined('SITE_URL')) define('SITE_URL', env_value('SITE_URL', 'https://sashtechnologies.com'));
