...
$json_ld = [
    ...
    '@graph' => [
        [
            ...
            'address' => [
                '@type' => 'PostalAddress',
                'streetAddress' => 'Block L, North Nazimabad',
...
<a href="<?= $base_path ?>" class="brand" aria-label="Sash Technologies home"><img src="<?= $base_path ?>assets/images/darklogo.png" alt="Sash Technologies logo" class="brand-logo"></a>
...
<aside class="side-panel" id="side-panel" aria-hidden="true"><div class="panel-head"><a href="<?= $base_path ?>" class="brand"><img src="<?= $base_path ?>assets/images/darklogo.png" alt="Sash Technologies logo" class="brand-logo"></a><button id="menu-close" class="menu-close" aria-label="Close menu">×</button></div><div class="panel-scroll"><nav class="panel-nav"><a href="<?= $base_path ?>">Home</a><a href="<?= $base_path ?>about">About</a><details open><summary>Services</summary><div class="panel-service-grid"><?php foreach ($all_services as $slug=>$service): ?><a href="<?= service_url($slug) ?>"><span class="service-menu-icon"><?= htmlspecialchars(strtoupper(substr($service['title'],0,2))) ?></span><?= htmlspecialchars($service['title']) ?></a><?php endforeach; ?></div></details><a href="<?= $base_path ?>portfolio">Portfolio</a><a href="<?= $base_path ?>blog">Articles</a><a href="<?= $base_path ?>faq">FAQs</a><a href="<?= $base_path ?>careers">Careers</a><a href="<?= $base_path ?>contact">Contact</a><a href="<?= $base_path ?>schedule">Schedule a Call</a></nav></div><div class="panel-contact"><span>Let’s talk</span><a href="mailto:info@sashtechnologies.com">info@sashtechnologies.com</a><a href="tel:+923372435249">+92 337 2435249</a><p>Block L, North Nazimabad, Karachi</p><div class="panel-cta-row"><a class="btn btn-primary" href="<?= $base_path ?>contact">Start a project</a><a class="btn btn-ghost" href="<?= $base_path ?>schedule">Book a call</a></div></div></aside>
<main>