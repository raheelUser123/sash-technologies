...
<section class="cta-section primary-cta-section"><div class="container"><div class="cta-panel reveal primary-cta-panel"><div><span class="eyebrow">Let’s work together</span><h2>Have a project in mind?</h2><p>Let’s create something bold, memorable, and built to perform.</p><div class="cta-row"><a href="contact.php" class="btn btn-primary">Start a project →</a><a href="schedule.php" class="btn btn-ghost">Get in touch →</a></div></div><div class="cta-logo">UD</div></div></div></section>
