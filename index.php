...
<section><div class="container"><div class="section-head reveal"><div class="eyebrow">What we do</div><h2>One coordinated partner across your customer journey.</h2><p>We connect strategy, creative, technology, marketing, and business operations so every touchpoint feels intentional.</p></div><div class="grid grid-3"><a class="image-card reveal" href="web-design.php"><img src="https://images.unsplash.com/photo-1551434678-e076c223a692?auto=format&fit=crop&w=900&q=80" alt="Web development team"><div><span class="eyebrow">Digital products</span><h3>Web & commerce</h3><p>Conversion-led websites, hosting, stores, mobile experiences, and presentations.</p><span class="text-link">Explore →</span></div></a><a class="image-card reveal" href="social-media-marketing.php"><img src="https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=900&q=80" alt="Marketing workshop"><div><span class="eyebrow">Demand generation</span><h3>Marketing & brand</h3><p>Content, social media, identity, graphic design, PR, and outbound campaigns.</p><span class="text-link">Explore →</span></div></a><a class="image-card reveal" href="business-consulting.php"><img src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=900&q=80" alt="Business consulting meeting"><div><span class="eyebrow">Business support</span><h3>Operations & consulting</h3><p>Project management, recruiting, analytics, writing, accounting, and tax support.</p><span class="text-link">Explore →</span></div></a></div><div class="center more-space"><a class="btn btn-ghost" href="services.php">View all 21 services →</a></div></div></section>

<section class="section-alt glow-section"><div class="container split"><div class="reveal"><div class="eyebrow">Why URDigital</div><h2>One accountable team instead of disconnected vendors.</h2><p>We plan around your business goal, coordinate every discipline, and keep communication clear from kickoff through launch.</p><ul class="plain-list"><li>Clear scope, milestones, and ownership</li><li>Regular updates and documented decisions</li><li>Responsive, accessible, SEO-ready delivery</li><li>Testing before launch and support after handoff</li></ul><a class="text-link" href="about.php">Meet your digital growth partner →</a></div><div class="visual-stack reveal"><img class="rounded-image" src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=1100&q=80" alt="Collaborative team"><div class="visual-badge"><strong>1 team</strong><span>Coordinated delivery</span></div></div></div></section>
