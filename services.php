...
<section class="cta-section"><div class="container"><div class="cta-panel reveal"><div><span class="eyebrow">Not sure where to begin?</span><h2>Tell us the goal. We’ll recommend the right combination.</h2><p>Share your priorities and we will shape a clear, practical scope around them.</p><div class="cta-row"><a class="btn btn-primary" href="contact.php">Start a project →</a><a class="btn btn-ghost" href="schedule.php">Book a call →</a></div></div><div class="cta-logo"><img src="<?= $base_path ?>assets/images/HOME PAGE SASH TECHNOLOGIES/FOOTER ICON/FOOTER ICON.png" alt="Sash Technologies Logo"></div></div></div></section><?php include 'includes/footer.php'; ?>