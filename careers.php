...
<section><div class="container"><div class="section-head reveal"><div class="eyebrow">Why join us</div><h2>Perks, benefits & team culture.</h2><p>We work remotely, communicate clearly, and empower driven professionals with great benefits and real growth.</p></div><div class="grid grid-3" style="gap:20px;"><article class="card reveal spotlight-card" style="padding:24px;"><div style="width:52px; height:52px; margin-bottom:14px; display:flex; align-items:center; justify-content:center; background:rgba(122,89,211,0.1); border-radius:14px; border:1px solid rgba(122,89,211,0.25);"><img src="assets/images/career  section icon sash technologies/competitive salary.svg" alt="Competitive Salary Icon" style="width:32px; height:32px;"></div><h3>Competitive Salary</h3><p>Earn market-leading base pay, performance bonuses, and uncapped commission structures.</p></article><article class="card reveal spotlight-card" style="padding:24px;"><div style="width:52px; height:52px; margin-bottom:14px; display:flex; align-items:center; justify-content:center; background:rgba(122,89,211,0.1); border-radius:14px; border:1px solid rgba(122,89,211,0.25);"><img src="assets/images/career  section icon sash technologies/flexible  time  icon.svg" alt="Flexible Time Icon" style="width:32px; height:32px;"></div><h3>Flexible Schedule</h3><p>Work remotely with flexible working hours tailored around high-productivity energy windows.</p></article><article class="card reveal spotlight-card" style="padding:24px;"><div style="width:52px; height:52px; margin-bottom:14px; display:flex; align-items:center; justify-content:center; background:rgba(122,89,211,0.1); border-radius:14px; border:1px solid rgba(122,89,211,0.25);"><img src="assets/images/career  section icon sash technologies/working hours icon.svg" alt="Working Hours Icon" style="width:32px; height:32px;"></div><h3>Work-Life Balance</h3><p>Clear core operating hours that protect your personal time while keeping client momentum high.</p></article><article class="card reveal spotlight-card" style="padding:24px;"><div style="width:52px; height:52px; margin-bottom:14px; display:flex; align-items:center; justify-content:center; background:rgba(122,89,211,0.1); border-radius:14px; border:1px solid rgba(122,89,211,0.25);"><img src="assets/images/career  section icon sash technologies/latest equipment.svg" alt="Latest Equipment Icon" style="width:32px; height:32px;"></div><h3>Latest Equipment</h3><p>We provide stipend & hardware access for modern laptops, software licenses, and productivity tools.</p></article><article class="card reveal spotlight-card" style="padding:24px;"><div style="width:52px; height:52px; margin-bottom:14px; display:flex; align-items:center; justify-content:center; background:rgba(122,89,211,0.1); border-radius:14px; border:1px solid rgba(122,89,211,0.25);"><img src="assets/images/career  section icon sash technologies/learning budget icon.svg" alt="Learning Budget Icon" style="width:32px; height:32px;"></div><h3>Learning Budget</h3><p>Annual budget for courses, certifications, book stipends, and professional growth programs.</p></article><article class="card reveal spotlight-card" style="padding:24px;"><div style="width:52px; height:52px; margin-bottom:14px; display:flex; align-items:center; justify-content:center; background:rgba(122,89,211,0.1); border-radius:14px; border:1px solid rgba(122,89,211,0.25);"><img src="assets/images/career  section icon sash technologies/team event icon.svg" alt="Team Events Icon" style="width:32px; height:32px;"></div><h3>Team Events</h3><p>Virtual meetups, games, rewards, and team milestone celebrations that keep work fun.</p></article></div></div></section>
...
<section class="cta-section primary-cta-section"><div class="container"><div class="cta-panel primary-cta-panel reveal"><div><span class="eyebrow">Don't see your role?</span><h2>Tell us how you can help.</h2><p>We are always looking for talented, reliable people. Send us your details and we will keep you in mind.</p><div class="cta-row"><button type="button" class="btn btn-primary apply-btn" data-job="General Application" data-location="Remote" data-type="Open">Apply Anyway →</button><a href="contact.php" class="btn btn-ghost">Contact us ↗</a></div></div><div class="cta-logo"><img src="<?= $base_path ?>assets/images/HOME PAGE SASH TECHNOLOGIES/FOOTER ICON/FOOTER ICON.png" alt="Sash Technologies Logo"></div></div></div></section>
